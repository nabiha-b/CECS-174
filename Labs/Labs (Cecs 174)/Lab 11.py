...
def upper_lower_case():
    ...
    print("Enter a series of aphabetical letters.")
...
def max_numbers():
    ...
    for i in range (4):
        ...
        #Add eachg entered number into list
        num_list.append(x)
    print(num_list)
...
def odd_even_counter():
    ...
    #Create empty list
    random_num_list = []
    #Create and initate variable for odd and even numbers
    odds = 0
    evens = 0
...
def main():
    ...
    try:
        ...
        option = int(input("Game selection ( Enter menu selection): "))
