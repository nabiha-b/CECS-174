...
# create function that displays initial from a given name
def name():
    print("** Initial Creator **")
...
def string_reversal():
    print("** Word Reverser")
    original_string = input("Enter a word: ")  # Get string from user input
